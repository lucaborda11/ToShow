...
templates['person'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<body>\n    <section class=\"personContainer\">\n\n        "
    ...
    + " \n            </article>\n            <div class=\"redes\">\n                "
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"redes") || (depth0 != null ? lookupProperty(depth0,"redes") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"redes","hash":{},"data":data,"loc":{"start":{"line":13,"column":16},"end":{"line":13,"column":27}}}) : helper))) != null ? stack1 : "")
    + "\n            </div>\n        </div>\n    </section>\n</body>\n</html>";
},"useData":true});
})();
